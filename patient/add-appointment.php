                                ...
                                <select name="doctor_id" class="form-control">
                                    ...
                                    ?>
                                        <option value="<?php echo
                                                        $row['doctor_id'] ?>"><?php echo $row['doctor_id'] . ' : ' . $row['first_name'] . ' ' . $row['last_name'] . ' : ' . $row['specialization'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="specialization" id="" class="form-control">
                                    ...
                                    ?>
                                        ...
                                        <option value="<?php echo $row['specialization'] ?>"><?php echo $row['specialization'] ?></option> <?php } ?>
                                </select>
                            </div>
                        </div>
                    </div>
